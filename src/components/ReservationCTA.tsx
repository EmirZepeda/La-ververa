        ...
        <section id="reservar" className="py-20 px-6 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-lg mx-auto text-center">
                ...
                <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="inline-flex items-center gap-3 px-10 py-5 rounded-2xl warm-gradient text-white text-lg font-bold shadow-2xl shadow-terracotta/30 animate-pulse-soft"
                >
                    Reservar Mesa
                    <motion.span
                        animate={{ x: [0, 5, 0] }}
